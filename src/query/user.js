export default Object.freeze({
    ...
    findUserByAccount: `SELECT id, account, nickname, profile, disclosure FROM USERS WHERE account = :account ORDER BY nickname`,
    findUserByNickname: `SELECT id, account, nickname, profile, disclosure FROM USERS WHERE nickname = :nickname ORDER BY nickname`,
